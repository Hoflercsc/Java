/** Name: Jonathan Hofler, Ani Desai, Donna Ridgeway
 * Hangman Case Study
 */
...
public class HangmanFinal extends Applet{     // Beginning of class 
	...
	Color bgColor = new Color(0xCCFFFF); //background color using HEX code



 public void init()
     {
	        picture = getImage(getDocumentBase(),"hangman3.jpg"); // adding image
			...
			welcome = "Welcome " + firstName +"!";
			  ...
			  "Do you want to view the game manual before you play?",  // prompt the user
			  "Question",
     ...
     public void newGame() // new game method
     {
     ...
     public String getHiddenWord() 
     {
          String[] wordList = {"pizza" , "watermelon","pomegranate","artichokes","basketball",  // Game words 
				               "gymnastics", "voleyball", "racing", "australia", "vatican", 
